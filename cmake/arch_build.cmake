...
function(add_cfe_tables APP_NAME TBL_SRC_FILES)
    ...
    foreach(TBL ${TBL_SRC_FILES} ${ARGN})
        ...
        foreach(TGT ${TABLE_TGTLIST})
            ...
            if (EXISTS "${MISSION_DEFS}/${MISSION_PROFILE}/tables/${TGT}_${TBLWE}.c")
                set(TBL_SRC "${MISSION_DEFS}/${MISSION_PROFILE}/tables/${TGT}_${TBLWE}.c")
            elseif (EXISTS "${MISSION_DEFS}/${MISSION_PROFILE}/${TGT}/tables/${TBLWE}.c")
                set(TBL_SRC "${MISSION_DEFS}/${MISSION_PROFILE}/${TGT}/tables/${TBLWE}.c")
            elseif (EXISTS "${MISSION_DEFS}/${MISSION_PROFILE}/tables/${TBLWE}.c")
                set(TBL_SRC "${MISSION_DEFS}/${MISSION_PROFILE}/tables/${TBLWE}.c")
            elseif (EXISTS "${MISSION_DEFS}/tables/${TGT}_${TBLWE}.c")
...
function(process_arch SYSVAR)
  ...
  foreach(TGTNAME ${TGTSYS_${SYSVAR}})
    ...
    foreach(INSTFILE ${${TGTNAME}_FILELIST})
      if(EXISTS ${MISSION_DEFS}/${MISSION_PROFILE}/${TGTNAME}/${INSTFILE})
        set(FILESRC ${MISSION_DEFS}/${MISSION_PROFILE}/${TGTNAME}/${INSTFILE})
      elseif(EXISTS ${MISSION_DEFS}/${MISSION_PROFILE}/${TGTNAME}_${INSTFILE})
        set(FILESRC ${MISSION_DEFS}/${MISSION_PROFILE}/${TGTNAME}_${INSTFILE})
      elseif(EXISTS ${MISSION_DEFS}/${MISSION_PROFILE}/${INSTFILE})
        set(FILESRC ${MISSION_DEFS}/${MISSION_PROFILE}/${INSTFILE})
